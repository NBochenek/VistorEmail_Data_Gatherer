...
def send_email(subject, body):
    ...
    receiver_emails = ["nick.bochenek@nonprofitmegaphone.com", "paul.pullara@nonprofitmegaphone.com "]  # Add additional recipient email addresses here
    ...
    with smtplib.SMTP(smtp_server, smtp_port) as server:
        ...
        server.sendmail(sender_email, receiver_emails, message.as_string())  # Note the receiver_emails list
